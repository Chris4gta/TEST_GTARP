...
API.onResourceStart.connect(function (sender, e) {
    ...
    for (var i = 0; i < vehicleHashes.length; i++) {
        var vehicleHash = vehicleHashes[i];
        var vehicleClass = vehicleClassNames[API.getVehicleClass(vehicleHash)];
    ...
    for (var group in groupedVehicles) {
        ...
        var groupName = group;
        var test = groupedVehicles[group];
